  ...
  <div class="guide-panel"><div data-wizard-init>
    ...
    <div class="steps-content">
      <div data-step="1">
        ...
        <p>Description of shortness of breath, what was patient doing prior to having breathing problem, associated symptoms, any medications taken, duration of breathlessness, any relieved by medication</p>
        ...
        <action-panel class="col-xs-6">
          <h4><b>Action Taken</b></h4><hr>
            <div class="action-content">
              ...
              <p>Instruct care giver or patient to <b class="important-color">ACTIVATE 995</b> Ambulance for assistance</p>
              <p>CareHub Team to activate 995 Ambulance on behalf if:</p>
              <ul>
                <li>Patient sounded in distress</li>
                <li>Drowsy</li>
